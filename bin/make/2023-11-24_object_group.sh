...
OUTXML=2023-11-24_object_group.xml
MERGEDXML=2023-11-24_merged.xml
...
bin/syncmake.sh
python src/merge_xml.py prod_update/normal/2023-11-20_merged.xml prod_make/normal/$OUTXML prod_update/normal/$MERGEDXML -v 2
bin/syncprod.sh
