...
INXML=2023-11-27_patched.xml
OUTXML=2023-11-27_object_group.xml
MERGEDXML=2023-11-27_merged.xml
...
bin/syncmake.sh
python src/merge_xml.py prod_update/normal/$INXML prod_make/normal/$OUTXML prod_update/normal/$MERGEDXML -v 1
bin/syncprod.sh
